"""
Django settings for cardapio_de_produtos project.
...
ALLOWED_HOSTS = ["catalogo-lapg.onrender.com", '127.0.0.1']
CSRF_TRUSTED_ORIGINS = ['https://catalogo-lapg.onrender.com', 'http://127.0.0.1']
...
ROOT_URLCONF = 'cardapio_de_produtos.urls'
...
WSGI_APPLICATION = 'cardapio_de_produtos.wsgi.application'
